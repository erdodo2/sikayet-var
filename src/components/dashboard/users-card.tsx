export default function StudentsCard(){
    return (
        <div className={" bg-gradient-to-r from-[#FEAF00] to-[#F8D442] w-full rounded-lg  flex flex-col p-6"}>
            <UsersIcon/>
            <span className={"text-[14px] font-[500] mt-3 text-white"}>Users</span>
            <span className={"text-[30px] font-[700] mt-3 text-end text-white"}>3</span>
        </div>
    )
}
function UsersIcon(){
